...
def distribution_sets():
    generator_set = {  
            'swarm': [  ss.norm(loc=loc, scale=scale),
            ...
            'omega': [  ss.alpha(3.57, loc=loc, scale=scale),
            ...
            'phi_p': [  ss.alpha(3.57, loc=loc, scale=scale),
                        ss.arcsine(loc=loc, scale=scale), 
                        ss.argus(1, loc=loc, scale=scale), 
                        ss.beta(2.31, 0.63, loc=loc, scale=scale),
                        ss.betaprime(5, 6, loc=loc, scale=scale),
            ...
            'phi_g': [  ss.alpha(3.57, loc=loc, scale=scale),
                        ss.arcsine(loc=loc, scale=scale), 
                        ss.argus(1, loc=loc, scale=scale), 
                        ss.beta(2.31, 0.63, loc=loc, scale=scale),
                        ss.betaprime(5, 6, loc=loc, scale=scale),
