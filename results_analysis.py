...
def create_boxplot(df, criteria):
    ...
    for i in range(1, len(criteria_list) + 1):
        index_list.append(i)
    column = ['Best score', 'Max_acc', 'Max Iteration']
...
if __name__ == "__main__":
    ...
    func_name_all, func_unimodal, func_multimodal, func_separable, func_nonseparable = define_func_parameters(
        param_ftest)
    ...
    criteria = {
        'function_name': 'csendes',
        'swarm_distribution': None,
        'phi_p_distribution': phi_dist_all,
        'phi_g_distribution': phi_dist_all,
        'experiment': None,
    }
